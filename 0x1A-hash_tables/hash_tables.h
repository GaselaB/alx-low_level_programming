 ...
 * coz we want ht to use a chaining collision handling
 */
 ...
 * @sprev: A pointer to the previous linked list
 ...
 * coz we want the hash table to make  use of  a chaining collision handling.
